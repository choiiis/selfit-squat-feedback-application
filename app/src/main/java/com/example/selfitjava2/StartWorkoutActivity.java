...
//    private static final int CAMERA_FACING = Camera.CameraInfo.CAMERA_FACING_BACK; // Camera.CameraInfo.CAMERA_FACING_FRONT
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_workout_activity);
        ...
        ImageView takePicBtn = findViewById(R.id.button_main_capture);
        ...
        ImageView showResBtn = findViewById(R.id.button_show_result);
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])
                    ...
                    Snackbar.make(mLayout, "이 앱을 실행하려면 카메라와 외부 저장소 접근 권한이 필요합니다.",
                        ...
                        public void onClick(View view) {
                            ...
                            ActivityCompat.requestPermissions( StartWorkoutActivity.this, REQUIRED_PERMISSIONS,
